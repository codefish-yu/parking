...
(function ($) {
    ...
    function createWholeCalendar(settings, $this) {
        ...
        var domSkeleton = '<div class="jqyc" >'+
            '<div class="jqyc-year-chooser border-top border-bottom row align-items-center" data-current-year="' + year + '">' +
            '<div style="width:100px"><div style="width:30px;border-radius:50%"></div></div>'+
        ...
        if (startFromSunday) {
            var tableSkeleton = '<table class="table table-sm jqyc-table">' +
                ...
                '<th class="jqyc-th workday" scope="col">' + settings.l10n.su + '</th>' +
                '<th class="jqyc-th workday" scope="col">' + settings.l10n.mn + '</th>' +
                '<th class="jqyc-th workday" scope="col">' + settings.l10n.tu + '</th>' +
                '<th class="jqyc-th workday" scope="col">' + settings.l10n.we + '</th>' +
                '<th class="jqyc-th workday" scope="col">' + settings.l10n.th + '</th>' +
            ...
            var tableSkeleton = '<table class="table table-sm jqyc-table">' +
                ...
                '<th class="jqyc-th workday" scope="col">' + settings.l10n.we + '</th>' +
                '<th class="jqyc-th workday" scope="col">' + settings.l10n.th + '</th>' +
                '<th class="jqyc-th workday" scope="col">' + settings.l10n.fr + '</th>' +
                '<th class="jqyc-th" scope="col">' + settings.l10n.sa + '</th>' +
